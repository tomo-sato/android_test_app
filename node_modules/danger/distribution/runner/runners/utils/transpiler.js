...
var checkForNodeModules = function () {
    ...
    var checkForBabel = function (prefix) {
        require.resolve("".concat(prefix, "core")); // tslint:disable-line
    ...
    if (hasBabel) {
        ...
        try {
            require.resolve("".concat(babelPackagePrefix, "plugin-transform-typescript")); // tslint:disable-line
        ...
        try {
            require.resolve("".concat(babelPackagePrefix, "plugin-transform-flow-strip-types")); // tslint:disable-line
            hasFlow = true;
        }
        catch (e) {
...
var babelify = function (content, filename, extraPlugins) {
    var babel = require("".concat(babelPackagePrefix, "core")); // tslint:disable-line
