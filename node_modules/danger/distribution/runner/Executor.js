    ...
    Executor.prototype.sendInlineComments = function (results, git, previousComments) {
        ...
        return Promise.all(__spreadArray([
            this.sendInlineReview(git, inlineResultsForReview).catch(function (_e) {
                return inlineResultsForReview.forEach(function (inlineResult) { return (0, DangerResults_1.inlineResultsIntoResults)(inlineResult); });
            })
        ], commentPromises, true)).then(function (dangerResults) {
            return new Promise(function (resolve) {
                resolve(dangerResults.slice(1).reduce(function (acc, r) { return (0, DangerResults_1.mergeResults)(acc, r); }, emptyResult));
            });
        });
    };
