...
var runRunner = function (app, config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                appPackageContent = (0, fs_1.readFileSync)((0, path_1.join)(__dirname, "../../../package.json"), "utf8");
                version = JSON.parse(appPackageContent).version;
                d("Debug mode on for Danger v".concat(version));
            ...
            case 2:
                ...
                platform = configPlatform || (0, platform_1.getPlatformForEnv)(process.env, source);
                ...
                return [4 /*yield*/, (0, dslGenerator_1.jsonDSLGenerator)(platform, source, app)];
            case 3:
                ...
                processName = (app.process && (0, runDangerSubprocess_1.addSubprocessCallAguments)(app.process.split(" "))) || undefined;
                ...
                (0, runDangerSubprocess_1.runDangerSubprocess)(runnerCommand, dangerJSONDSL, exec, runConfig);
                _b.label = 4;
